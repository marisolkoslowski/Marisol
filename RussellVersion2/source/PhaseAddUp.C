...
#include "PhaseAddUp.h"
#include "libmesh/quadrature.h"

registerMooseObject("MooseApp", PhaseAddUp);

InputParameters
PhaseAddUp::validParams()
{
...
PhaseAddUp::PhaseAddUp(const InputParameters & parameters)
  : Material(parameters),
...
void
PhaseAddUp::initQpStatefulProperties()
{
}

void
PhaseAddUp::computeQpProperties()
{
