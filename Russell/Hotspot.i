...
[Kernels]
  #Temperature
    ...
    [Heat_FiniteStress_EOS_ART]
      type = Heat_FiniteStress_EOS_ART
...
[BCs]
  ...
  #[Plate_Ends_x]  type = DirichletBC  variable = disp_x  value = 0  boundary = 'outer'[]#'0 1 2 3'[]
  #[Plate_Ends_y]  type = DirichletBC  variable = disp_y  value = 0  boundary = 'outer'[]#'0 1 2 3'[]
[]
################################################################################
[Materials]
  #General Constants
  ...
  #Mie Grunessien Equation Of State
    [pressure_eos]
      ...
      Gamma = 0.667
      slope_UsUp = 1.613  #c0 is 4.158, will need to check against the value calculated in code, or rewrite to avoid using bulk modulus
  ...
  [plate_stress]    
   type = ComputeFiniteStress_EOS_ART 
   C0 = 0.1  
   C1 = 1.0
 ...
 ###Eos###
  [SpecificVolume]   type = SpecificVolume  []
  ...
  #  
  #  property_name = pressure_eos
  #  sum_materials = 'pressure_Y_RDX pressure_Y_RDX pressure_Y_RDX'
