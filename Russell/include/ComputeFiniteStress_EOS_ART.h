...
class ComputeFiniteStress_EOS_ART : public ComputeStressBase//, public Material
{
public:
  static InputParameters validParams();
  ComputeFiniteStress_EOS_ART(const InputParameters & parameters);
...
protected:
 ...
 //Moose Properties/Variables
  ...
  //Debugging
   MaterialProperty       <Real> & _report_output;
